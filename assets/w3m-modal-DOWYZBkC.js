import{p as ve,w as fe,s as ge,q as be,R as l,M as g,t as se,i as v,r as P,a as f,x as a,u as K,e as ce,o as le,h as m,d as Y,j as ye,v as S,E as ie,O as E,C as q,y as oe,k as T,A as H,T as xe,z as Ce,b as ke,g as Se}from"./core-DqPSnCSr.js";import{c as u,n as w,r as d,o as F,U as We}from"./index-DtsKEY-0.js";import"./index-znPAFL8M.js";import"./events-B2IGFv-C.js";import"./index.es-CZhQyJfa.js";import"./index-nibyPLVP.js";const p=ve({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),Re={state:p,subscribe(r){return ge(p,()=>r(p))},subscribeKey(r,e){return be(p,r,e)},showTooltip({message:r,triggerRect:e,variant:t}){p.open=!0,p.message=r,p.triggerRect=e,p.variant=t},hide(){p.open=!1,p.message="",p.triggerRect={width:0,height:0,top:0,left:0}}},O=fe(Re),de={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){g.shake();return}if(await se.isSIWXCloseDisabled()){g.shake();return}g.close()}},$e=v`
  :host {
    display: block;
